...
/**
 * This type of bag can only contain strings
 *
 * Class StringBag
 * @package Kiron\Bags
 *
 * @since 1.0.0
 */
class StringBag implements BagInterface, \ArrayAccess
{
    use BagTrait;
    use BagArrayTrait;
    ...
    public function set($id, $value) {
        if(is_string($value))  {
            ...
            throw new BagException('[Kiron\Bags\StringBag: set] the specified $value is not an object');
        }
    }
